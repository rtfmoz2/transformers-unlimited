...
public class ItemEnergonChunkDark
extends ItemFood
implements IHasModel {
    ...
    public ItemEnergonChunkDark(String name, int amount, boolean isWolfFood, int StackSize, int health, int cooldown) {
    ...
    public ActionResult<ItemStack> func_77659_a(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (playerIn.func_110143_aJ() != playerIn.func_110138_aP()) {
            ...
            playerIn.field_71071_by.func_174925_a(ModItems.DARK_ENERGON_MUG, 0, 1, null);
        }
