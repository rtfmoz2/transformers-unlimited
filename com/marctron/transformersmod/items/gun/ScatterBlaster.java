...
extends ItemGunBase {
    ...
    protected void spawnBullet(World world, EntityPlayer player) {
        ...
        for (int i = 0; i < 6; ++i) {
            world.func_72838_d((Entity)new EntityBullet(world, (EntityLivingBase)player, 16.0f).setDamage(2.0f));
        }
    }

    @Override
    public void func_77624_a(ItemStack stack, @Nullable World world, List<String> list, ITooltipFlag flag) {
        list.add(TextFormatting.GREEN + I18n.func_135052_a((String)(TextFormatting.BOLD + I18n.func_135052_a((String)"Common", (Object[])new Object[0])), (Object[])new Object[0]));
