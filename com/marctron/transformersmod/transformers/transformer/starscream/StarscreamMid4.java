...
public class StarscreamMid4
extends ItemArmor
implements IHasModel {
    @SideOnly(value=Side.CLIENT)
    private static ModelStarscreamMid3 model = new ModelStarscreamMid3();

    public StarscreamMid4(String name, ItemArmor.ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
        ...
        timer.schedule(new TimerTask(){
            ...
            public void run() {
                if (itemStack.func_77973_b() == ModItems.STARSCREAM_MID4_BOOTS && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(0, (Object)new ItemStack(ModItems.STARSCREAM_MID5_BOOTS));
                }
                if (itemStack.func_77973_b() == ModItems.STARSCREAM_MID4_LEGGINGS && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(1, (Object)new ItemStack(ModItems.STARSCREAM_MID5_LEGGINGS));
                }
                if (itemStack.func_77973_b() == ModItems.STARSCREAM_MID4_CHESTPLATE && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(2, (Object)new ItemStack(ModItems.STARSCREAM_MID5_CHESTPLATE));
                }
                if (itemStack.func_77973_b() == ModItems.STARSCREAM_MID4_HELMET && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(3, (Object)new ItemStack(ModItems.STARSCREAM_MID5_HELMET));
                }
                if (itemStack.func_77973_b() == ModItems.SKYWARP_MID4_BOOTS && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(0, (Object)new ItemStack(ModItems.SKYWARP_MID5_BOOTS));
                }
                if (itemStack.func_77973_b() == ModItems.SKYWARP_MID4_LEGGINGS && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(1, (Object)new ItemStack(ModItems.SKYWARP_MID5_LEGGINGS));
                }
                if (itemStack.func_77973_b() == ModItems.SKYWARP_MID4_CHESTPLATE && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(2, (Object)new ItemStack(ModItems.SKYWARP_MID5_CHESTPLATE));
                }
                if (itemStack.func_77973_b() == ModItems.SKYWARP_MID4_HELMET && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(3, (Object)new ItemStack(ModItems.SKYWARP_MID5_HELMET));
                }
                if (itemStack.func_77973_b() == ModItems.THUNDERCRACKER_MID4_BOOTS && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(0, (Object)new ItemStack(ModItems.THUNDERCRACKER_MID5_BOOTS));
                }
                if (itemStack.func_77973_b() == ModItems.THUNDERCRACKER_MID4_LEGGINGS && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(1, (Object)new ItemStack(ModItems.THUNDERCRACKER_MID5_LEGGINGS));
                }
                if (itemStack.func_77973_b() == ModItems.THUNDERCRACKER_MID4_CHESTPLATE && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(2, (Object)new ItemStack(ModItems.THUNDERCRACKER_MID5_CHESTPLATE));
                }
                if (itemStack.func_77973_b() == ModItems.THUNDERCRACKER_MID4_HELMET && world.field_72995_K) {
                    player.field_71071_by.field_70460_b.set(3, (Object)new ItemStack(ModItems.THUNDERCRACKER_MID5_HELMET));
                }
            }
        }, 70L);
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
        if (!itemStack.func_190926_b() && itemStack.func_77973_b() instanceof ItemArmor) {
            StarscreamMid4.model.field_78116_c.field_78806_j = armorSlot == EntityEquipmentSlot.HEAD;
            StarscreamMid4.model.field_178720_f.field_78806_j = armorSlot == EntityEquipmentSlot.HEAD;
            StarscreamMid4.model.field_78115_e.field_78806_j = armorSlot == EntityEquipmentSlot.CHEST || armorSlot == EntityEquipmentSlot.CHEST;
            StarscreamMid4.model.field_178723_h.field_78806_j = armorSlot == EntityEquipmentSlot.CHEST;
            StarscreamMid4.model.field_178724_i.field_78806_j = armorSlot == EntityEquipmentSlot.CHEST;
            StarscreamMid4.model.field_178721_j.field_78806_j = armorSlot == EntityEquipmentSlot.LEGS;
            StarscreamMid4.model.field_178722_k.field_78806_j = armorSlot == EntityEquipmentSlot.LEGS;
            StarscreamMid4.model.field_78117_n = _default.field_78117_n;
            StarscreamMid4.model.field_78093_q = _default.field_78093_q;
            StarscreamMid4.model.field_78091_s = _default.field_78091_s;
            StarscreamMid4.model.field_187076_m = _default.field_187076_m;
            StarscreamMid4.model.field_187075_l = _default.field_187075_l;
            return model;
        }
        return null;
    }
