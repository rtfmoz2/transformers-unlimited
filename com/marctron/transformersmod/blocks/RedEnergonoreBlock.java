...
public class RedEnergonoreBlock
extends BlockBase {
    private final boolean isOn;

    public RedEnergonoreBlock(String name, Material material, boolean isOn) {
        super(name, material);
    ...
    public Item func_180660_a(IBlockState state, Random par2Random, int par3) {
        return new ItemStack(ModItems.RED_ENERGON_SHARD).func_77973_b();
    }
    ...
    private void spawnParticles(World worldIn, BlockPos pos) {
        ...
        for (int i = 0; i < 6; ++i) {
            ...
            worldIn.func_175688_a(EnumParticleTypes.REDSTONE, d1, d2, d3, 1.0, 0.0, 0.0, new int[0]);
        }
    }
}
