...
public class BlueEnergonoreBlock
extends BlockBase {
    ...
    public Item func_180660_a(IBlockState state, Random par2Random, int par3) {
        return new ItemStack(ModItems.BLUE_ENERGON_SHARD).func_77973_b();
    }
    ...
    private void spawnParticles(World worldIn, BlockPos pos) {
        ...
        for (int i = 0; i < 6; ++i) {
            ...
            worldIn.func_175688_a(EnumParticleTypes.REDSTONE, d1, d2, d3, 0.1, 0.65, 1.0, new int[0]);
        }
    }
}
